...
df = gpd.read_file(r'.\geo-analysis\data\ne_110m_admin_1_states_provinces.shp')
# print(df.head())
...
districts = gpd.read_file(r".\geo-analysis\data\Congressional_Districts.shp")
districts.to_file(driver='GeoJSON',filename=r'.\geo-analysis\data\Congressional_Districts.geojson')

vn = gpd.read_file(r"C:\data\MySHPLocal\SPC_PRV_ADMZONE.shp")
vn.to_file(driver='GeoJSON',filename=r'.\geo-analysis\data\SPC_PRV_ADMZONE.geojson')
...
df.to_csv(path_or_buf=r'.\geo-analysis\data\states_provinces.csv', sep='\t', encoding='utf-8')
df.to_file(driver='GeoJSON',filename=r'.\geo-analysis\data\states_provinces.geojson')

states = gpd.read_file(r".\geo-analysis\data\ne_110m_admin_1_states_provinces.shp")
...
print(fires.crs)
print(states.crs)
fires.to_file(driver='GeoJSON',filename=r'.\geo-analysis\data\mtbs_FODpoints_DD.geojson')
